...
const { getOrder, addProductToOrder, removeProductToOrder, moreQuantity, lessQuantity, canceledOrder, completedOrder, clearProduct } = require("../../controllers/api/cart");
...
router.patch("/clear", clearProduct)
